 ...
 * @param {{ filterArea?: string, filterBuilding?: string, communityAliasMap?: Map<string, string>|null }} [opts] - area/building as sales filter; optional alias map (else COMMUNITY_ALIAS_JSON on server)
 */
