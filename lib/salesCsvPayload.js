...
export function buildPayloadFromCsvText(csvRaw, label = 'uploaded.csv', options = {}) {
  ...
  const normalizedRecords = normalizeLocationHierarchy(records, 'drillCommunityBuilding', 'subCommunity', 'area');
  // Replace records in-place so downstream code uses normalized fields
  records.length = 0;
